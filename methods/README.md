...
| --- | --- | --- | --- | --- |
| L1 | Visual | 40 | A. Pixel and geometric artifacts / B. Physiological features / C. Distribution discrepancy and robustness | [Open](layer-1-intrinsic-cues.md) |
...
| L3 | Language | 65 | A. Audio-visual consistency detection / B. Text-video semantic consistency reasoning / C. Robust learning and temporal localization | [Open](layer-3-cross-modal.md) |
| L4 | Language | 27 | A. Prompts and adapters for representation calibration / B. Evidence-guided and agentic systems / C. Post-training, preferences and rewards | [Open](layer-4-world-level-reasoning.md) |
