...
These works consume visual sequence evidence. BioLip and LoCC remain in Layer 2 even though their attack setting is lip-sync manipulation, because neither consumes audio at inference; CAM-VFD is also Layer 2 because its appearance, motion, and depth branches are all visual.

| Date | Method | Paper | Decisive cue / mechanism | Output | Venue |
| --- | --- | --- | --- | --- | --- |
| 07/2026 | SemaDet | [Detecting AI-Generated Videos via Global Semantic Awareness and Inter-Frame Semantic Consistency](https://doi.org/10.1016/j.neucom.2026.133530)<br>Xiang et al. | Global semantics and inter-frame semantic consistency | Score | Neurocomputing |
| 07/2026 online | High--Low Frequency Decoupling | [Detecting the Imperceptible: A High-Low Frequency Decoupling Network for Partial Video Inpainting Forgery Detection](https://doi.org/10.1016/j.eswa.2026.133490)<br>Xie et al. | Decoupled high/low-frequency traces for partial inpainting | Score+loc. | ESWA |
| 06/2026 | Color-Agnostic Curriculum | [Robust AI-Generated Video Detection via Color-Agnostic Contrastive Curriculum Learning with Color-Aware Feature Modulation](https://doi.org/10.1109/TCSVT.2026.3701354)<br>Zhu et al. | Color-agnostic curriculum, histogram modulation, temporal Transformer | Score | IEEE TCSVT |
| 06/2026 | TriMoE | [TRIMOE: Three-Domain Mixture-of-Experts Framework for Deepfake Identification](https://openaccess.thecvf.com/content/CVPR2026W/PPMisDet/html/Dutta_TRIMOE_Three-Domain_Mixture-of-Experts_Framework_for_Deepfake_Identification_CVPRW_2026_paper.html)<br>Dutta et al. | Sparse routing over spatial, spectral, and temporal experts | Score | CVPRW |
| 05/2026 | Kol-3-Freq | [Kol-3-Freq: Frequency-Aware Video Deepfake Detection Using Kolmogorov-Arnold Networks](https://doi.org/10.1109/TBIOM.2026.3694120)<br>Dutta et al. | Three-band frequency features with Kolmogorov--Arnold modeling | Score | IEEE TBIOM |
| 03/2026 | Multi-Grained ST Learning | [A Multi-Grained Parallel Spatio-Temporal Learning Architecture for Deepfake Video Detection](https://doi.org/10.1145/3789507)<br>Miao et al. | Parallel spatiotemporal learning at multiple granularities | Score | ACM TOMM |
| 03/2026 | Facial Biometric Anomalies | [Detecting Deepfake Talking Heads from Facial Biometric Anomalies](https://openaccess.thecvf.com/content/WACV2026W/SAFE-2026/html/Norman_Detecting_Deepfake_Talking_Heads_from_Facial_Biometric_Anomalies_WACVW_2026_paper.html)<br>Norman and Farid | Identity-specific facial biometric anomalies | Score | WACVW |
| 02/2026 online | 3D Differential Decomposition | [3D Differential Decomposition for Video Deepfake Detection with Identity Suppression](https://doi.org/10.1016/j.image.2026.117525)<br>Gao et al. | 3D differential traces with identity suppression | Score | SPIC |
| 07/2026 | SPLIT | [SPLIT: Training-Free AI-Generated and Partially Edited Video Detection via Spatial Patch-Level Incoherence and Temporal Roughness](https://arxiv.org/abs/2607.02886)<br>Hyun and Kim | Patch trajectories, temporal roughness, and local motion incoherence | Score | arXiv |
| 04/2026 | Aletheia | [Aletheia: Physics-Conditioned Localized Artifact Attention (PhyLAA-X) for End-to-End Generalizable and Robust Deepfake Video Detection](https://arxiv.org/abs/2604.16486)<br>Ghori | Flow curl, specular skewness, and rPPG-gated spatiotemporal attention | Score | arXiv |
| 03/2026 | STALL | [Training-Free Detection of Generated Videos via Spatial-Temporal Likelihoods](https://arxiv.org/abs/2603.15026)<br>Hayun et al. | Training-free spatial-temporal likelihood score | Score | CVPR |
| 01/2026 | MPF-Net | [MPF-Net: Exposing High-Fidelity AI-Generated Video Forgeries via Hierarchical Manifold Deviation and Micro-Temporal Fluctuations](https://arxiv.org/abs/2601.21408)<br>He et al. | Manifold deviation and micro-temporal fluctuations | Score | arXiv |
...
| 07/2026 | STREAM | [Beyond Pixels: Mining Compressed Domain Artifacts for Efficient AI-Generated Video Detection](https://icml.cc/virtual/2026/poster/62999)<br>Zhu et al. | Codec I-frames, motion vectors, and residuals | Score | ICML |
| 06/2026 | LoCC | [LoCC: Detection and Localization of Lip-Syncing Deepfakes via Counterfactual Frame Consistency](https://arxiv.org/abs/2606.22772)<br>Datta et al. | Audio-free counterfactual frame consistency | Score+loc. | ICME |
| 06/2026 | CUPID | [CUPID: Reconstructing UV Texture Maps for Interpretable Person-of-Interest Deepfake Detection](https://arxiv.org/abs/2606.20302)<br>Affatato et al. | Identity-specific UV-texture residuals | Score+loc. | arXiv |
...
| 05/2026 | Optical-Neural Detector | [Scalable, Energy-Efficient Optical-Neural Architecture for Multiplexed Deepfake Video Detection](https://arxiv.org/abs/2605.19360)<br>Kashani et al. | Multiplexed visual streams with optical decoding | Score | arXiv |
| 05/2026 | Social-Media 3D CNN | [Deepfake Detection in Social Media: A Temporal Artifact Analysis Using 3D Convolutional Neural Networks](https://arxiv.org/abs/2605.17573)<br>Rashidi et al. | 3D CNN with temporal-consistency regularization | Score | arXiv |
| 05/2026 | SpecSem-Net | [SpecSem-Net: Integrating Spectral and Semantic Features for Robust AI-Generated Video Detection](https://arxiv.org/abs/2605.17311)<br>Wei et al. | Semantic-guided spectral denoising | Score | arXiv |
...
| 05/2026 | SpInShield | [Exposing and Mitigating Temporal Attack in Deepfake Video Detection](https://arxiv.org/abs/2605.07398)<br>Gu et al. | Temporal-spectrum attack and adversarial defense | Score | arXiv |
| 05/2026 | MAST | [Detecting AI-Generated Videos with Spiking Neural Networks](https://arxiv.org/abs/2605.05895)<br>Jang et al. | Spike-driven temporal residuals | Score | arXiv |
| 04/2026 | DYMAPIA | [DYMAPIA: A Multi-Domain Framework for Detecting AI-Based Video Manipulation](https://arxiv.org/abs/2604.24426)<br>Rana et al. | Spatial, spectral, edge, texture, and flow fusion | Score | arXiv |
| 04/2026 | Facial Dynamics | [Interpretable Facial Dynamics as Behavioral and Perceptual Traces of Deepfakes](https://arxiv.org/abs/2604.21760)<br>Murphy et al. | Low-dimensional facial motion irregularities | Score | arXiv |
| 04/2026 | BioLip | [BioLip: Language-Generalizable Lip-Sync Deepfake Detection via Biomechanical Constraint Violation Modeling](https://arxiv.org/abs/2604.16808)<br>Chen and Xu | Landmark kinematics and biomechanics | Score | arXiv |
| 04/2026 | Native Scale | [Preserving Forgery Artifacts: AI-Generated Video Detection at Native Scale](https://openreview.net/forum?id=XD43lfRCg6)<br>Li et al. | Variable spatial scale and temporal duration | Score | ICLR |
| 04/2026 | Moiré Authentication | [Moiré Video Authentication: A Physical Signature Against AI Video Generation](https://arxiv.org/abs/2604.01654)<br>Qing et al. | Fringe-phase/grating-displacement correlation across video motion | Score | arXiv; ECCV author-reported |
| 03/2026 | Over-Coherence | [Training-Free Detection of Text-to-Video Generations via Over-Coherence](https://openaccess.thecvf.com/content/WACV2026/html/Brokman_Training-free_Detection_of_Text-to-video_Generations_via_Over-coherence_WACV_2026_paper.html)<br>Brokman et al. | Unnaturally stable temporal transitions | Score | WACV |
| 03/2026 | SVD-Det | [SVD-Det: A Lightweight Framework for Video Forgery Detection Using Semantic and Visual Defect Cues](https://openaccess.thecvf.com/content/WACV2026/html/Yang_SVD-Det_A_Lightweight_Framework_for_Video_Forgery_Detection_Using_Semantic_WACV_2026_paper.html)<br>Yang et al. | Semantic and visual-defect cues | Score | WACV |
| 02/2026 | EA-Swin | [EA-Swin: An Embedding-Agnostic Swin Transformer for AI-Generated Video Detection](https://arxiv.org/abs/2602.17260)<br>Mai et al. | Scale- and duration-aware windows | Score | arXiv |
| 01/2026 | RT-DeepLoc | [Mining Forgery Traces from Reconstruction Error: A Weakly Supervised Framework for Multimodal Deepfake Temporal Localization](https://arxiv.org/abs/2601.21458)<br>Guo et al. | Authentic-only masked reconstruction and temporal contrast | Score+loc. | arXiv |
| 01/2026 | ExposeAnyone | [ExposeAnyone: Personalized Audio-to-Expression Diffusion Models Are Robust Zero-Shot Face Forgery Detectors](https://arxiv.org/abs/2601.02359)<br>Shiohara et al. | Identity-compatible expression dynamics | Score | arXiv |
| 01/2026 | DDNet | [DDNet: A Dual-Stream Graph Learning and Disentanglement Framework for Temporal Forgery Localization](https://arxiv.org/abs/2601.01784)<br>Zhao et al. | Local and long-range temporal graphs | Score+loc. | arXiv |
