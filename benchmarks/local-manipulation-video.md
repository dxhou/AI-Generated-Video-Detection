...
LMV benchmarks preserve an authentic carrier and remain the historical backbone of video deepfake evaluation. They are especially useful for compression robustness, localized forensic residue, codec variation, and cross-dataset transfer.

| Date | Benchmark / Dataset | Paper | Focus | Venue |
| --- | --- | --- | --- | --- |
| 03/2026 | CharadesDF / Human--AI audit | [Human-AI Ensembles Improve Deepfake Detection in Low-to-Medium Quality Videos](https://arxiv.org/abs/2603.14658)<br>Postiglione et al. | Everyday mobile footage tested with 200 people and 95 detectors. | arXiv |
| 07/2026 | HumanForge | [HumanForge: A Human-Centric Deepfake Video Benchmark with Multi-Agent Forgery Rationales](https://arxiv.org/abs/2607.08705)<br>Xu et al. | Multi-paradigm human interactions, temporal rationales, and multimodal alignment. | arXiv |
| 06/2026 | TASLE | [Explainable Forensics of Manipulated Segments in Untrimmed Long Videos](https://arxiv.org/abs/2606.02402)<br>Feng et al. | 12,472 untrimmed videos with temporal boundaries and rationales. | ICML |
| 06/2026 | Temporally Localized Manipulations | [Detecting Temporally Localized Manipulations in Authentic Video Streams](https://arxiv.org/abs/2606.07090)<br>Umur et al. | Short manipulated intervals embedded within authentic streams. | arXiv |
| 04/2026 | ActivityForensics | [ActivityForensics: A Comprehensive Benchmark for Localizing Manipulated Activity in Videos](https://openaccess.thecvf.com/content/CVPR2026/html/Bao_ActivityForensics_A_Comprehensive_Benchmark_for_Localizing_Manipulated_Activity_in_Videos_CVPR_2026_paper.html)<br>Bao et al. | Over 6K action-level manipulated segments with temporal boundaries. | CVPR |
...
| 03/2025 | ExDDV | [ExDDV: A New Dataset for Explainable Deepfake Detection in Video](https://openaccess.thecvf.com/content/WACV2026/html/Hondru_ExDDV_A_New_Dataset_for_Explainable_Deepfake_Detection_in_Video_WACV_2026_paper.html)<br>Hondru et al. | Benchmark for explainable AIGC-V video detection. | WACV 2026 |
